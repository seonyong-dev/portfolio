...
<span style="font-size:100px">"주사기 대신 키보드"</span>

"**최적의 해답을 찾고 무한한 과정을 즐기는**" 진선용입니다.
간호사로서 쌓아온 실무 경험을 기반으로,
...
25년 10월 29일부터 26년 04월 29일까지 6개월 동안 개발자 훈련 과정을 통해 Java, Python, Spring MVC, Git, AI 등 활용하여 '비대면 과제관리 시스템'과 '식품 커머스 플랫폼' 프로젝트를 진행함으로써 직무 경험을 쌓았습니다.<br /><br />
2026년 5월부터 진행 중인 '모임 정산 프로그램' 개인 프로젝트를 통해 Spring Boot와 React 등 기존에 접해보지 못했던 신기술에 도전하며 풀스택 개발 프로세스를 주도적으로 연마했습니다.
특히 트랜잭션 처리와 정산 로직의 정합성에 대해 깊이 고민하며 시스템 안정성을 높이는 데 집중했습니다. 매일 작업 내용을 담은 '일별 개발일지'를 꾸준히 작성해 왔으며, 자잘한 에러부터 아키텍처적 고민까지 집요하게 기록하고 해결하는 트러블슈팅 역량을 길렀습니다.<br />
